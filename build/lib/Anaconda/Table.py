...
class CSVFormat (object):
    ...
    def __init__(self):
        ...
        self._lineDelimiter='\n'
        def formatter (a):
            if isinstance(a,float) and abs(a - a.round()) <= 0.000001:
                a = int(a.round());
            return str(a)
    ...
    def setFormatter(self,function):
        """Sets the formater for the fields"""
        self._formatter = function
    ...
    def writeColoums(self,coloums):
        ...
        return self._fieldDelimiter.join([str(a) for c in coloums]);
